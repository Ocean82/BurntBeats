...
interface MelodyGenerationConfig {
  lyrics: string
  genre: string
  mood: string
  tempo: number
...
export class MelodyGenerator {
  ...
  private emotionWeights: Record<string, number> = {
    // Positive emotions
    love: 0.9, joy: 0.8, happy: 0.7, beautiful: 0.6, amazing: 0.7,
    wonderful: 0.8, perfect: 0.6, dream: 0.5, sunshine: 0.7, freedom: 0.6,
    hope: 0.5, smile: 0.6, dance: 0.7, fly: 0.6, soar: 0.8, bright: 0.5,

    // Negative emotions
    sad: -0.7, pain: -0.8, hurt: -0.6, broken: -0.7, lonely: -0.6,
    dark: -0.5, tears: -0.6, goodbye: -0.5, lost: -0.6, empty: -0.7,
    cold: -0.4, fear: -0.6,

    // Neutral/contextual
    time: 0.0, day: 0.1, night: -0.2, way: 0.0, life: 0.2,
    world: 0.1, heart: 0.3, soul: 0.2,
  }
